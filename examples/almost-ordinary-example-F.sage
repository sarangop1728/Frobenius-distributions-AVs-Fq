...
# -----------------------------------------------------------
# Example 6.4.2 (F)
# link: https://www.lmfdb.org/Variety/Abelian/Fq/3/2/ac_d_ag
# -----------------------------------------------------------
# LMFDB label:
label = "3.2.ac_d_ag"
...
u1_squared = aa^2/q
# As expected, the relative norm of u1^2 is a primitive 4-th root of 1
nrm = u1_squared.relative_norm()
print([nrm^n for n in [1,2,3,4]])